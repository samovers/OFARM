...
# Legacy reference — api and specs
...
- `fastapi-README.md`
- `openapi-farm-rm.yaml`
- `specs-api-v1-README.md`
- `specs-v1.0.0-README.md`
- `specs-v1.0.0-package-index.md`
- `specs-v1.0.0-release-manifest.json`
- `specs-v1.0.0-version-map.md`
