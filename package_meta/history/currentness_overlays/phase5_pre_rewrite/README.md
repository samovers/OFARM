...
# OFARM 2 package — CP15 current package note
...
# OFARM 2 — current active package
...
Start here, then read `CURRENT_ACTIVE_ENTRYPOINT.md`, `PROJECT_AUTHORITY.md`, and `ACTIVE_SUBSTANCE_README.md`.

Active-law read order:
...
Supporting/non-authoritative by default:
...
- `archive/review_holding/`
- `legacy_reference/`
- `package_meta/`

CP12 is merged as a bounded active baseline/RFC/companion/conformance amendment. CP12 machine contracts remain draft/non-default only.
...
Repository steward remediation: `package_meta/history/controlled_amendments/cp12_steward_remediation_2026_05_28/`.
...
Historical lineage: CP10 and CP11 remain prior endpoints and active historical lineage where merged; they are not the current package endpoint.
