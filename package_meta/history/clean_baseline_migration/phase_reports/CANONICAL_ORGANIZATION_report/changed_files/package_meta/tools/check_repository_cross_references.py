...
def history_or_provenance(path: str, line: str) -> bool:
    ...
    return (
        ...
        or path.startswith("CANONICAL_ORGANIZATION_REPORT")
        ...
        or path in {"03_machine_contracts/PATH_REMAPS.json", "package_meta/history/clean_baseline_migration/ledgers/CLEAN_BASELINE_RELOCATION_MAP.json"}
