...
Date: 2026-09-07. Amended: 2026-09-15, Scope B version 1 draft with covered-expiry projection correction.
...
What is next: re-review the exact covered-expiry correction, its truthful uniform public projection and C38 pair, then obtain renewed semantic approval of Scope B. Keep the closed waits, explicit privacy cost, actual-C acknowledgement guarantee, uniform exclusion, CP2A-DEP01 and all binding/implementation gates intact.
