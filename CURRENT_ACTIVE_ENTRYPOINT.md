...
This is the concise human entrypoint for the materialized CP15 development baseline.
...
These views are reader/control views only. They do not override canonical authority.

## Controlled-amendment evidence

CP11 through CP15 package-meta evidence now lives at `package_meta/history/controlled_amendments/`.

The CP15 merge evidence pointer is repaired to existing evidence:

`package_meta/history/controlled_amendments/cp15_merge_2026_05_30/CP15_FINAL_ACCEPTANCE_GATE.md`
