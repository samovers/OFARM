...
- Broken links preserved in review/legacy snapshots: 166
- Actionable stale currentness references: 0
- Next-phase phrase candidates: 0
- Duplicate basename groups: 156
- Duplicate content-hash groups: 128
- Active-schema same-basename copies outside active schema folders: 0
- Schema-copy index coverage issues: 0
- Manifest error groups: 0
...
- jsonParses: PASS
- noActionableBrokenMarkdownLinks: PASS
- noActionableStaleCurrentnessReferences: PASS
- noActionableNextPhasePhrases: PASS
- schemaCopyIndexesCoverKnownCopies: PASS
- noUnexpectedActiveSchemaBasenameCopies: PASS
- manifestPathSetCurrent: PASS
