# OFARM external evidence rehearsal fixtures v0.1

Date: 2026-04-20
Status: active supporting implementation artifact
Scope: bounded non-qualifying rehearsal support for the first external evidence packet

---

## Purpose

This wave adds a rehearsal lane that sits **outside** the canonical live-evidence drop zones.
It gives deployment teams one production-shaped runtime-surface packet and one production-shaped partner-output telemetry packet to inspect before sending real artifacts.
...
- `ofarm_external_evidence_rehearsal_runner_v0_2.py`
...
The package now has:
- one current external-evidence intake packet
- one current pilot handoff kit
- one explicit non-qualifying rehearsal lane

The package still has zero qualifying live deployment evidence artifacts.
