# OFARM external evidence pilot handoff packet v0.1

Date: 2026-04-20
Status: active supporting implementation artifact
Scope: practical handoff packet for the first real deployment team sending OFARM external evidence into the current intake lane
...
The remaining debt is **attributable deployment evidence**.
...
2. complete `OFARM_External_Evidence_Pilot_Day0_Operator_Checklist_v0_1.md`
...
6. keep blocked runs, warnings, and denials; they are still evidence
