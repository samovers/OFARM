# OFARM external evidence pilot day-0 operator checklist v0.1

Date: 2026-04-20
Status: active supporting implementation artifact
Scope: first-packet checklist for deployment teams sending runtime-surface or partner-output evidence into the current intake lane
...
- [ ] `ofarm_external_evidence_intake_runner_v0_2.py` passes
