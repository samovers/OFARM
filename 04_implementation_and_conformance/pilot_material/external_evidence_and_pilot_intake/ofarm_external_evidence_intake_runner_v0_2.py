...
REGISTRY = IMPL / 'OFARM_external_evidence_intake_registry_v0_2.json'
PACKET = IMPL / 'OFARM_External_Evidence_Intake_Packet_v0_2.md'
HANDOFF = IMPL / 'OFARM_External_Evidence_Pilot_Handoff_Packet_v0_1.md'
CHECKLIST = IMPL / 'OFARM_External_Evidence_Pilot_Day0_Operator_Checklist_v0_1.md'
...
SNAP_V5 = IMPL / 'OFARM_post_hardening_readiness_snapshot_v0_5.json'
RESULTS_OUT = IMPL / 'OFARM_external_evidence_intake_results_v0_2.json'
...
def main() -> int:
    ...
    snapshot = load_json(SNAP_V5)

    results: dict[str, Any] = {
        'evaluatedAt': now_iso(),
        'packetRef': PACKET.name,
        'registryRef': REGISTRY.name,
        'snapshotRef': SNAP_V5.name,
        'dropZoneChecks': {},
        'artifactDiscovery': {},
        'summary': {},
        'limitations': [
            ...
            'The pilot handoff kit and rehearsal lane reduce operator ambiguity but do not reduce the qualifying-evidence debt by themselves.'
        ],
    ...
    results['dropZoneChecks']['registry-overall-posture'] = 'PASS' if registry.get('overall') == 'PREPARED_FOR_PILOT_HANDOFF_AND_EXTERNAL_EVIDENCE_COLLECTION' else 'FAIL'
