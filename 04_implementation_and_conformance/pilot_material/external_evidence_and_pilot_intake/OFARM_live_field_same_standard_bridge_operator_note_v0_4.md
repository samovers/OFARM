# OFARM live-field same-standard bridge operator note v0.4

Date: 2026-04-20
Status: active supporting implementation artifact
Scope: operator-facing steps for placing future same-standard bridge promotion evidence into the authenticity-gated external evidence intake lane and forward into the reviewer-side decision lane

Supersedes:
- `OFARM_live_field_same_standard_bridge_operator_note_v0_3.md`
...
4. complete the authenticity envelope and qualification claim for each artifact
5. run `ofarm_external_evidence_intake_runner_v0_4.py`
6. hand the packet to the reviewer using `OFARM_External_Evidence_Reviewer_Handoff_Packet_v0_2.md`
7. record any accountable bridge decision under `live_evidence_decisions/same_standard_bridge/`
8. refresh bridge-promotion posture only if all three evidence classes are present, authenticity-gated, and later covered by explicit accountable review decisions
...
- do not leave `authenticityEnvelope.repositoryAuthored` as `true`
- do not call a rehearsal packet real bridge evidence
