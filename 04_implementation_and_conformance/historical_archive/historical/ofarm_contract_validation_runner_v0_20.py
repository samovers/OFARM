...
RESULTS = OUT_DIR / 'OFARM_machine_contract_validation_results_v0_20.json'
NEGATIVE = OUT_DIR / 'OFARM_machine_contract_negative_validation_records_v0_3.json'
REFERENCE = OUT_DIR / 'OFARM_machine_contract_reference_consistency_records_v0_3.json'
