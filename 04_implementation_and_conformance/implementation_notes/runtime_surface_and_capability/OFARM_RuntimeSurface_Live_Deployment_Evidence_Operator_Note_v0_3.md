# OFARM RuntimeSurface live deployment evidence operator note v0.3

Date: 2026-04-20
Status: active supporting implementation artifact
Scope: operational guidance for turning the runtime-surface live-evidence templates into future deployment-specific artifacts under the current intake and reviewer-decision lane
...
5. the artifact survives `ofarm_external_evidence_intake_runner_v0_3.py`
6. an accountable reviewer later records a matching disposition through `live_evidence_decisions/` and `ofarm_external_evidence_decision_runner_v0_1.py`
