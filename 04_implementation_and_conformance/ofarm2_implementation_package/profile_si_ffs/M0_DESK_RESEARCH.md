...
7. ~~GERK open-data round-trip~~ **DONE 2026-06-12** — steward-confirmed: the known farm's GERK-PIDs resolve against the national open-data layer and attributes match ("they match"). Recorded as steward attestation; the paste-safe detailed report was not retained. Onboarding design (open layer + KMG-MID + parcel confirmation) stands.
