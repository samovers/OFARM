...
def main() -> int:
    ...
    for rel, expected_status in {
        "03_machine_contracts/schemas/README.md": "MACHINE_CONTRACT_CURRENT_DEFAULT_SCHEMA",
        "03_machine_contracts/drafts_non_default/README.md": "MACHINE_CONTRACT_DRAFT_NON_DEFAULT",
